    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/alivalit/crutch/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/alivalit/crutch.git")
                    developerConnection.set("scm:git:ssh://github.com/alivalit/crutch.git")
                    url.set("https://github.com/alivalit/crutch/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/alivalit/crutch/issues")
                }
            }
        }
    }
